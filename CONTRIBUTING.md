...
`cloud-itonami-iso3166-jpn-meti` accepts contributions to the OSS actor, governor tests,
...
- Keep production actions behind the Industrial-Policy Compliance Governor.
- Never let the advisor state a legal/tax conclusion as fact — every
  regulatory requirement must cite the official METI source.
